...
DEBUG   = 0     # Debug 0/1
SPEED   = 1   #Puhumisnopeus
VOLUME  = 80


SOUNDS  = "/home/pi/sounds/"
CAMERA  = "raspistill -hf -vf -cfx 128:128 --awb auto -rot 180 -t 500 -o /tmp/image.jpg"
...
def playTTS():
    logger.info('playTTS()') 
    global current_tts
    current_tts=subprocess.Popen(['/usr/bin/flite','-voice','awb','-f', '/tmp/text.txt'], #kal awb_time kal16 awb rms slt
